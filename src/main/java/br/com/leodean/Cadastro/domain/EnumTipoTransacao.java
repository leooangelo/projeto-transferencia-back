...
public enum EnumTipoTransacao {
    ...
    TRANS_DIA(1, "  TRANS_DIA", "Tranferências no mesmo dia do agendamento tem uma taxa de $3 mais 3% do valor a ser transferido"),
    TRANS_DIA_10(2, "TRANS_DIA_10", "Tranferências até 10 dias da data de agendamento possuem uma taxa de $12"),
